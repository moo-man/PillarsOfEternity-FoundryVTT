export class ActorEnduranceModel extends foundry.abstract.DataModel 
{
    ...
    {
        this.tooltips?.endurance.threshold.winded.push(game.i18n.format("PILLARS.Tooltip", { value: this.threshold.winded, source: game.i18n.localize("PILLARS.TooltipBase") }));
        ...
        this.tooltips?.endurance.threshold.winded.push(game.i18n.format("PILLARS.Tooltip", { value: armor?.system.winded?.value, source: game.i18n.localize("PILLARS.TooltipArmor") }));
        this.tooltips?.endurance.threshold.winded.push(game.i18n.format("PILLARS.Tooltip", { value: shield?.system.winded?.value, source: game.i18n.localize("PILLARS.TooltipShield") }));
    }
}